...
class RoomDrawer:
    def __init__(self, room):
        ...
        cv2.rectangle(self.img, (self.x_min, self.y_min), (self.x_max, self.y_max), (230, 230, 190), -1)
        cv2.circle(self.img, (self.width // 2, self.height // 2), int(self.room.get_max_carpet_radius()),
                   (51, 153, 253), -1)
        self.draw_things()

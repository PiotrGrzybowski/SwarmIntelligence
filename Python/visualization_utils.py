...
class RoomDrawer:
    ...
    def draw_thing(self, thing, i):
        ...
        cv2.rectangle(self.img, self.point_transfer(thing.x_min, thing.y_min), self.point_transfer(thing.x_max, thing.y_max), color, 1)
